...
- [x] **ESLE-04**: Yeni mülk eklendiğinde uygun müşterilere otomatik bildirim gitmeli
- [x] **ESLE-05**: Yeni müşteri eklendiğinde uygun mülkler önerilmeli
- [x] **ESLE-06**: AI piyasa verilerine göre fiyat önerisi yapabilmeli
- [x] **ESLE-07**: Kullanıcı değerleme raporunu görebilmeli
...
- [x] **PORT-05**: Kullanıcı sistemden sahibinden.com'a ilan yükleyebilmeli
- [x] **PORT-06**: Kullanıcı sistemden hepsiemlak'a ilan yükleyebilmeli
- [x] **PORT-07**: Kullanıcı sistemden emlakjet'e ilan yükleyebilmeli
...
- [x] **MOBL-06**: Push notification ile bildirim alınabilmeli
- [x] **MOBL-07**: Yeni eşleşme bildirim olarak gelmeli
...
- [x] **ILET-07**: Gönderilen e-postaların durumunu takip edebilmeli
